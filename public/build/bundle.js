...
var app = (function () {
    ...
    /* src/routes/Members.svelte generated by Svelte v3.44.3 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 17, 8, 481);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route$1({
    			props: { path: "members", component: Members },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1x5z4hm");
    			add_location(h1, file, 13, 8, 360);
    			if (!src_url_equal(img.src, img_src_value = /*st4rt*/ ctx[1])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Image Error");
    			attr_dev(img, "class", "svelte-1x5z4hm");
    			add_location(img, file, 14, 8, 383);
    			add_location(div, file, 12, 4, 346);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    			...
    			if (!mounted) {
    				dispose = listen_dev(img, "click", /*toggle_btns*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function toggle_btns() {
    		$$invalidate(0, visible = visible ? false : true);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('st4rt' in $$props) $$invalidate(1, st4rt = $$props.st4rt);
    	...
    	return [visible, st4rt, toggle_btns];
    }
